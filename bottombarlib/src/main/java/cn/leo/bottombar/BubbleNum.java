...
public class BubbleNum extends View {
    ...
    private void initPaint() {
        ...
        mTextPaint.setTextSize(mOneDip * 3);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (heightSpecMode == MeasureSpec.AT_MOST ||
                heightSpecMode == MeasureSpec.UNSPECIFIED) {//包裹内容的时候
            heightMeasureSpec = MeasureSpec.makeMeasureSpec((int) mOneDip * 12, MeasureSpec.EXACTLY);
            height = (int) (mOneDip * 12 + 0.5);
        }
